...
def iceberg_prediction(
    ...
    **kwargs,
    ...
    Args:
        ...
        num_gpu_workers: (int, default=6) number of parallel GPU workers
        num_cpu_workers: (int, default=16) number of parallel CPU workers
    ...
    if force_recompute or not (save_dir / 'iceberg_run_successful').exists():
        ...
        cmd = (f'''{python_path} {Path(__file__).resolve().parent / "predict_smis.py"} \\
