#!/usr/bin/env python3
"""Run MassSpecGym retrieval evaluation for msg_all_iceberg."""
...
DATASET = "msg_all_iceberg"
GEN_CHECKPOINT = Path("results/iceberg_msg_all_iceberg/split_rnd1/ckpt/gen/best.ckpt")
INTEN_CHECKPOINT = Path("results/iceberg_msg_all_iceberg/split_rnd1/ckpt/inten_contr/best.ckpt")
SAVE_ROOT = Path("results/iceberg_msg_all_iceberg/split_rnd1")
