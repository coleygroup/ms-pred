...
res_entries = [
    {"folder": "results/iceberg_nist20/split_1_rnd1/",
     "dataset": "nist20",
     "test_split": "split_1"},

    # {"folder": "results/iceberg_nist20/split_1_rnd2/",
    #  "dataset": "nist20",
    #  "test_split": "split_1"},

    # {"folder": "results/iceberg_nist20/split_1_rnd3/",
    #  "dataset": "nist20",
    #  "test_split": "split_1"},

    # {"folder": "results/iceberg_nist20/scaffold_1_rnd1/",
    #  "dataset": "nist20",
    #  "test_split": "scaffold_1"},

    # {"folder": "results/iceberg_nist20/scaffold_1_rnd2/",
    #  "dataset": "nist20",
    #  "test_split": "scaffold_1"},

    # {"folder": "results/iceberg_nist20/scaffold_1_rnd3/",
    #  "dataset": "nist20",
    #  "test_split": "scaffold_1"},
]
