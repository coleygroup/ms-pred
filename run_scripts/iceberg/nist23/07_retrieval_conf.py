...
def train_models_and_test(
    ...
    for k in ks:
        ...
        rep = {
            ...
            "confidence_threshold@0.90_accuracy": evaluate_confidence_threshold(y_test, p_test),
...
if __name__ == "__main__":
    ...
    train_yaml = "results/iceberg_nist23/split_1_rnd1/retrieval_nist23_split_1_val_50/rerank_eval_entropy.yaml"
    test_yaml = "results/iceberg_nist23/split_1_rnd1/retrieval_nist23_split_1_50/rerank_eval_entropy.yaml"
    out_dir = "results/iceberg_nist23/split_1_rnd1/retrieval_confidence"
    topk_features = 15
    ...
    for k in (1, 3, 5, 10):
        ...
        thresh_rep = rep.get("confidence_threshold@0.90_accuracy")
        if thresh_rep is None:
            print("No confidence threshold reaches 0.90 accuracy.")
        else:
            print(
                f"Confidence threshold for 0.90 accuracy: {thresh_rep['threshold']:.4f} "
